  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">SHOP</span> giỏ
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<p class="text-muted" > Bạn hiện tại có <?php echo $count; ?> món hàng trong giỏ </p>
...
Tiến hành kiểm tra <i class="fa fa-chevron-right"></i>
...
echo "<script>alert('Mã phiếu giảm giá của bạn đã hết hạn')</script>";
...
echo "<script>alert('Mã phiếu thưởng của bạn đã được áp dụng')</script>";
...
echo "<script> alert('Mã phiếu giảm giá của bạn không hợp lệ') </script>";
...
<p class="text-muted">
Chi phí vận chuyển và bổ sung được tính dựa trên các giá trị bạn đã nhập.
</p>
