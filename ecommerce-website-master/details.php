  ...
  <main>
    ...
    <div class="nero">
      ...
      <div class="nero__heading">
        <span class="nero__bold">Sản phẩm </span>Xem
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<label class="col-md-5 control-label" >Loại sản phẩm</label>
...
<option>Nhỏ</option>
<option>Vừa<a href="http://" target="_blank" rel="noopener noreferrer"></a></option>
<option>Lớn</option>
...
<label class="col-md-5 control-label" >Số lượng gói </label>
...
<label class="col-md-5 control-label" >Cỡ gói</label>
...
echo "<script>alert('Sản phẩm này đã được thêm vào danh sách yêu thích')</script>";
...
echo "<script> alert('Sản phẩm đã được đưa vào danh sách yêu thích') </script>";
...
<a href='$pro_url' class='btn btn-default' >Chi tiết</a>
