...
<h1 align="center"> 
Vui lòng xác nhận thanh toán của bạn </h1>
...
echo "<script>alert('Thanh toán của bạn đã được nhận, đơn đặt hàng sẽ được hoàn thành trong vòng 24 giờ')</script>";
