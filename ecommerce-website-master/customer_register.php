...
<label> Liên lạc khách hàng </label>
...
<h2>
Xác nhận email bởi Computerfever.com $c_name
</h2>
...
echo "<script>alert('Vui lòng chọn Captcha, thử lại')</script>";
